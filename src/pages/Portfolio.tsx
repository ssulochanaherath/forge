...
const PortfolioPage = () => {
    return (
        <div className="min-h-screen w-full bg-white font-sans text-black">
            ...
            {/* Main Page Wrapper with padding-top to offset fixed navbar */}
            <div className="pt-24 px-8 md:px-32">
            ...
            {/* Footer */}
            <footer className="bg-[#1c1c1c] text-white py-10 px-8 md:px-32 relative">
